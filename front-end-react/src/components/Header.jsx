...
function Header() {
  ...
  return (
    <Fragment className="header">
      ...
      {/* Menu coulissant pour écrans étroits */}
      {isMenuOpen && (
        <div
          className="fixed top-0 right-0 w-2/5 h-full bg-gray-800 text-white shadow-lg z-50 2xl:hidden"
        >
          <button
          ...
          <ul className="p-6 space-y-4">
            <li>
              <Link to="/accueil" className="text-white" onClick={toggleMenu}>
                Accueil
              </Link>
            </li>
            <li>
              <Link to="/boutique" className="text-white" onClick={toggleMenu}>
                Boutique
              </Link>
            </li>
            {user.isAdmin && (
